...
extern const MIDL_SERVER_INFO interfaces_ServerInfo;

extern const RPC_DISPATCH_TABLE interfaces_v1_0_DispatchTable;
...
static const MIDL_STUB_DESC interfaces_StubDesc = 
    {
    (void *)& interfaces___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION interfaces_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE interfaces_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)interfaces_table
    };

static const SERVER_ROUTINE interfaces_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)HelloProc,
    (SERVER_ROUTINE)Shutdown
    };

static const MIDL_SERVER_INFO interfaces_ServerInfo = 
    {
    &interfaces_StubDesc,
    interfaces_ServerRoutineTable,
    interfaces__MIDL_ProcFormatString.Format,
    interfaces_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
